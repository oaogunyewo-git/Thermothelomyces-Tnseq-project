...
MySpeciesList = ['apoper-1', 'canare-1', 'chacoc-1','chathe-1', 'corsep-1', 'crahot-1', 'crathe-1', 'dicfun-1', 'gelunc-1', 'mycthe-1', 'neudis4-001b', 'parapp-1', 'parhyr-1', 'podans-001', 'podapp-1', 'podcur-1', 'thehet-1', 'theher-1', 'thethe-1', 'triant-1']	# MAKE A LIST OF SPECIES NAMES YOU ACTUALLY ARE INTERESTED IN
