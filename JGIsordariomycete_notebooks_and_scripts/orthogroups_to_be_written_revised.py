...
MySpeciesList = ['lashis-1', 'lashir-1', 'schves-1', 'cernew-1', 'cercau-1', 'poddid-1', 'lasovi-1', 'lasmin-1', 'bombom-1', 'cersco-1', 'podbul-1', 'arnari-1', 'podbac-1', 'podset-1', 
'podcom-1', 'podbel-1' 'podpse-1', 'madmyc-1', 'achmac-1', 'achstr-1', 'stalon-1', 'chalep-1', 'corina-1', 'chafim-1', 'cornov-1', 'apoper-1', 'canare-1', 'chacoc-1','chathe-1', 'corsep-1', 
'crahot-1', 'crathe-1', 'dicfun-1', 'mycthe-1', 'parapp-1', 'parhyr-1', 'podans-001', 'podapp-1', 'podcur-1', 'thehet-1', 'theter-1', 'thethe-1', 'triant-1']	
...
with open('Orthogroups.txt') as proj3file: # the ''   here makes this a string
		...
		if my_orthogroup_no_colon in single_copy_ortho:
			...
			if(n_overlap <> 43):	# if n_overlap isn't 20, give up and go on to the next orthogroup
				break
			else:
				print(n_overlap)	
